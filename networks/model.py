...
class Conv1dECG(nn.Module):
    ...
    def __init__(self, in_channels, num_filters, num_classes, input_size):
        ...
        self.swish1 = nn.SiLU()
        self.spatialDropout1 = nn.Dropout1d(p=0.5)
        ...
        self.swish2 = nn.SiLU()
        self.spatialDropout2 = nn.Dropout1d(p=0.5)
        ...
        self.swish3 = nn.SiLU()
        self.spatialDropout3 = nn.Dropout1d(p=0.5)
        ...
        self.swish4 = nn.SiLU()
        self.spatialDropout4 = nn.Dropout1d(p=0.5)
