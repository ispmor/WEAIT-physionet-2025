...
def train_model(data_folder, model_folder, verbose):
    ...
    training_config = TrainingConfig(batch_size=400,
    ...
    training_data_loader = torch_data.DataLoader(training_dataset, batch_size=400, shuffle=True, num_workers=6)
    test_data_loader = torch_data.DataLoader(test_dataset, batch_size=400, shuffle=True, num_workers=6)
